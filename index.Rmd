...
```{r Source table version 1}

### Version 1
tbl_SourceName <- c("","Capture production:", "Aquaculture production:","Trade (imports and exports):", "Purchases (within and out-of-home):", "Consumption:","Nutrient composition:")
tbl_URL <- c("","[UK sea fisheries annual statistics - GOV.UK (www.gov.uk)](https://www.gov.uk/government/collections/uk-sea-fisheries-annual-statistics)", "[Database - Eurostat (europa.eu)](https://ec.europa.eu/eurostat/web/main/data/database)", "[Trade data - UK Trade Info](https://www.uktradeinfo.com/trade-data/)",
             "[Family food statistics - GOV.UK (www.gov.uk)](https://www.gov.uk/government/collections/family-food-statistics)", "[National Diet and Nutrition Survey - GOV.UK (www.gov.uk)](https://www.gov.uk/government/collections/national-diet-and-nutrition-survey)", "[Nutrient Analysis of Fish - GOV.UK (www.gov.uk) and About the Norwegian Food Composition Table (matvaretabellen.no)](https://www.matvaretabellen.no/about-us/)")
...
tbl_Source %>% kbl(col.names = NULL, escape = FALSE) %>% kable_paper("hover", full_width = FALSE) %>% 
...
```{r}
tbl_contact <- c("Prof. Baukje de Roos",
...
Contact information: Prof. Baukje de Roos, [The Rowett Institute](https://www.abdn.ac.uk/rowett/), University of Aberdeen. E-mail: [b.deroos@abdn.ac.uk](b.deroos@abdn.ac.uk)
