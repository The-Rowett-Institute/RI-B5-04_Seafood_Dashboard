...
*	This unique database harmonises secondary datasets across the whole seafood supply chain, to species level, between 2009 and 2020 (the most up-to-date data available) for the United Kingdom (UK).
...
*	Capture production: [UK sea fisheries annual statistics - GOV.UK (www.gov.uk)](https://www.gov.uk/government/collections/uk-sea-fisheries-annual-statistics)
*	Aquaculture production: personal communications at CEFAS but data till 2018 can be found here [Database - Eurostat (europa.eu)](https://ec.europa.eu/eurostat/web/main/data/database)
*	Trade (imports and exports): [Trade data - UK Trade Info](https://www.uktradeinfo.com/trade-data/)
*	Purchases (within and out-of-home): [Family food statistics - GOV.UK (www.gov.uk)](https://www.gov.uk/government/collections/family-food-statistics)
*	Consumption: [National Diet and Nutrition Survey - GOV.UK (www.gov.uk)](https://www.gov.uk/government/collections/national-diet-and-nutrition-survey)
*	Nutrient composition: [Nutrient Analysis of Fish - GOV.UK (www.gov.uk) and About the Norwegian Food Composition Table (matvaretabellen.no)](https://www.matvaretabellen.no/about-us/)
...
* [PowerPoint Presentation (sefari.scot) 2023 May](https://sefari.scot/sites/default/files/documents/RESAS_DynamicEarthPosterFinal.pdf)

Contact
=======================================================================

Created by Anneli Lofstedt and Bernhard Scheliga.  

Contact information: Baukje de Roos, [The Rowett Institute](https://www.abdn.ac.uk/rowett/), University of Aberdeen. E-mail: [b.deroos@abdn.ac.uk](b.deroos@abdn.ac.uk)
